		      ...
		      '<div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10">',
		         ...
		         '<div class="row">',
		            ...
		            '<div class="col-xs-9">',
		               ...
		               '<input type="text" class="form-control" ng-model="laundryCtrl.cust.name" />',
		            '</div>',
		            '<div class="col-xs-3">',
		               '<label>Unit #</label>',
		               '<input type="text" class="form-control" ng-model="laundryCtrl.address.apt"  id="aptLoc"  />',
		            '</div>',
		         '</div>',
		         '<div class="row">',
		            '<div class="padder"></div>',
		            '<div class="col-xs-7">',
		               '<label>City</label>',
		               '<input type="text" class="form-control" ng-model="laundryCtrl.address.city" id="cityLoc"  value=" "/>',
		            '</div>',
		            '<div class="col-xs-2">',
		               '<label>State</label>',
		               '<input type="text" class="form-control" ng-model="laundryCtrl.address.state" value=" " />',
		            '</div>',
		            '<div class="col-xs-3">',
		               '<label>Zip Code</label>',
		               '<input type="text" class="form-control" ng-model="laundryCtrl.address.zip" value=" " />',
		            '</div>',
		         '</div>',
		         '<hr>',
